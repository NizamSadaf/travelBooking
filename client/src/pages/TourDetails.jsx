...
const TourDetails = () => {
  ...
  //const calReviews=tour.reviews ===undefined ? 0 : tour.reviews
  //console.log(calReviews)
                  ...
                  <div className="tour__info">
                    ...
                    <div className="d-flex align-items-center gap-5">
                      <span className='tour__rating d-flex align-items-center gap-1'>
                        <i class="ri-star-fill" style={{ color: "var(--secondary-color)" }}></i>{avgRating>0? avgRating : '' } {" "}
                        {totalRating > 0 ? 
                          (
                    ...
                    <div className="tour__reviews mt-4">
                      <h4>Reviews ({reviews?.length>0 ?  reviews?.length : 0 } reviews )</h4>
